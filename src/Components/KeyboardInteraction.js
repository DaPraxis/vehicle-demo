...
class GaugeComponent extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            maxWl: props.maxWl,
            minWl: props.minWl,
            num: props.maxWl - props.minWl + 1,
            pro: (props.initWl-props.minWl+1)/(props.maxWl-props.minWl+1)
        }
    }
    ...
    colorChanges(val){
        ...
        this.setState({...this.state, wlValue: val, num: this.state.maxWl - this.state.minWl + 1,
            pro: (this.state.wlValue-this.state.minWl+1)/(this.state.maxWl-this.state.minWl+1)})
    }
